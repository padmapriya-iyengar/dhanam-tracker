...
export default function AccountCategoryComparison({ account }) {
  ...
  return (
    <CollapsibleSection storageKey="account-overview-category-comparison" title="Monthly category comparison" subtitle="Compare expense categories and subcategories for the selected account" icon={BarChart3} defaultOpen={false} contentClassName="!p-0">
      <div className="border-b border-slate-100 p-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div><p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Comparison period</p><p className="mt-0.5 text-xs text-slate-400">Add or remove months to control the table.</p></div>
