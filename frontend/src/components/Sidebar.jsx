import { ArrowRightLeft, BarChart2, BellRing, Bot, Building2, CreditCard, Home, Landmark, Lightbulb, LogOut, ShoppingCart, Tag, TrendingUp, UserCog, Users, X } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/message-import', icon: Bot, label: 'Import Message' },
